...
class RRTV1:
    ...
    def __init__(self, start, goal, obstacle_list, rand_area,
        ...
        self.max_rand_x = rand_area[1][0]
        self.min_rand_y = rand_area[0][1]
...
# brus_goal1 = [0.67042778, 0.87705564]
# brus_start1 = [0.58046044, 1.83329783]
# brus_rand1 = [[0.0, 0.0], [3.0, 3.0]]

# def main(start, goal, rand_area):
...
#     rrt = RRT(start=brus_start1,
#               goal=brus_goal1,
#               rand_area=brus_rand1,
#               obstacle_list=[])
